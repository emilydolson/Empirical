...
namespace emp {
  ...
  public:
    ...
    virtual Shape2D & SetCenter(const Point & new_center) { center = new_center; return *this; }
    virtual Shape2D & SetCenterX(double new_x) { center.SetX(new_x); return *this; }
    virtual Shape2D & SetCenterY(double new_y) { center.SetY(new_y); return *this; }
    virtual Shape2D & SetRadius(double new_radius) { radius = new_radius; return *this; }
    virtual Shape2D & SetOrientation(Angle new_orientation) { orientation = new_orientation; return *this; }
    virtual Shape2D & Translate(Point shift) { center += shift; return *this; }
